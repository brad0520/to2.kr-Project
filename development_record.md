...
### to2.kr 프로젝트 준비
  - 소스 분석  
    - 연후가 입원이 필요한 정도로 아픈 관계로 퇴근 후 학습에 제약이 있음
    - 아주 조금씩이지만 소스를 보거나 관련 자료를 학습중

---
## 2021-11-06
### to2.kr 프로젝트 준비
  - 제약조건
    - SI 재계약 관련 준비 및 협상 과정에 따른 여가 시간 제약
    - 세 아들의 감기로 인한 간호
    - 소스를 집중해서 볼 수 있는 여건을 마련하지 못했던 기간이 생각보다 길어짐
  
  - 재계약 완료 후 집중모드
    - 재계약 완료 이후 직장과 집에서의 일 분리 및 개별 과제에 집중
    - 구입한 도서 정독 및 관련 인강 듣기
    - 소스 분석 및 로컬에서 구동 테스트 하고 소스 편집 시도 필요
...
### to2.kr 프로젝트 준비
  - 스프링 책 읽기
  - 소스 1회 정독 완료
    - 로컬에서 빌드하고 테스트하는 것을 아직 하지 못하고 있음
    - 빌드 관련 테스트가 필요

---
## 2021-12-16
### 서브 프로젝트
  - 현실적으로 육아와 학습을 병행하는데에 물리적인 제약이 있음
  - 현업에서 업무에 필요한 내용을 학습하는 것을 우선으로 하다보니 서브 프로젝트에 시간을 내기는 힘듬
  - 항상 서브 프로젝트를 염두하고 시간이 나면 관련 분야를 탐구할 필요가 있음
